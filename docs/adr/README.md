...
| [ADR-010](./ADR-010-commercial-agreement.md) | CommercialAgreement (B4.2) | **Accepted** — join table, không cột Order |
| [ADR-011](./ADR-011-org-order-pin.md) | Pin Order ↔ Organization (B3.3) | **Accepted** — join table, không cột Order |
