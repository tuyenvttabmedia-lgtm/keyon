...
export const defaultCmsFooter: CmsFooter = {
  ...
  legalLinks: [
    ...
    { label: "Chính sách giao hàng điện tử", href: "/policy/delivery" },
    { label: "Quy định sản phẩm số", href: "/policy/warranty" },
  ],
};
...
export const defaultCmsContact: CmsContact = {
  ...
  chatLabel: "Live Chat",
  chatValue: "Tạo ticket hỗ trợ",
  chatHint: "Trong Tài khoản KEYON",
  ...
  instantBody: "Đội ngũ hỗ trợ của KEYON sẵn sàng giúp bạn trong giờ làm việc",
