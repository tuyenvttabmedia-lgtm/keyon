...
export const defaultCmsCheckout: CmsCheckout = {
  ...
  trustBar: [
    ...
    { id: "t2", label: "Giao hàng theo gói", sub: "Xem ghi chú trên sản phẩm" },
  ...
  confirmTrustBar: [
    ...
    },
    {
      ...
      sub: "Ticket trong Tài khoản / liên hệ",
    },
  ],
  paymentMethods: [
    {
...
export const defaultCmsContact: CmsContact = {
  ...
  emailHint: "Phản hồi trong giờ làm việc",
  chatLabel: "Ticket hỗ trợ",
  chatValue: "Tạo ticket trong Tài khoản",
  chatHint: "Theo dõi và trả lời có lịch sử",
  ...
  formLead: "Điền form — KEYON phản hồi trong giờ làm việc.",
  ...
  instantTitle: "Cần hỗ trợ theo dõi?",
  instantBody:
    "Tạo ticket trong Tài khoản để KEYON theo dõi và trả lời có lịch sử.",
  instantCta: "Tạo ticket hỗ trợ",
  instantCtaHref: "/account/tickets",
  instantPerks: [
    "Phản hồi trong giờ làm việc",
    "Lịch sử ticket trong tài khoản",
...
export const defaultCmsPolicy: CmsPolicy = {
  ...
  detailSupportBody: "Đội ngũ KEYON sẵn sàng hỗ trợ bạn trong giờ làm việc hoặc qua ticket.",
