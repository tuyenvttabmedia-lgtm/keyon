...
/** Signature comparison workspace — interaction concept, not product claims. */
      ...
      <div className="home-container px-5 md:px-0">
        <div className="grid items-start gap-8 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="min-w-0 lg:col-span-7">
            <div
              className={`rounded-2xl border border-border bg-white p-5 sm:p-6 ${ELEVATION_FLOAT}`}
            >
              ...
              <div className={`mt-6 border-t border-border pt-5 ${ELEVATION_HAIRLINE}`}>
                ...
                <button
                  ...
                  className={`mt-4 inline-flex h-12 items-center justify-center rounded-xl bg-accent px-6 ${CTA_LABEL_CLASS} text-white ${TRANSITION_UI} hover:bg-accent-hover`}
                >
                  Nhận tư vấn →
                </button>
              </div>
