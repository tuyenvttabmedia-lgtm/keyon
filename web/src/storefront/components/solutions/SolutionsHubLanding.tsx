      ...
      <section className="border-b border-border bg-[#F7FAFC] py-10 md:py-12 lg:py-14">
        <div className="home-container">
          ...
          <p className={`mt-3 max-w-2xl ${PAGE_LEAD_CLASS}`}>
            Chọn hướng theo việc bạn cần làm — năng suất, cloud, bảo mật, backup
            hoặc quản lý license. Mua số lượng lớn, subscription và tư vấn B2B
            nằm ở Doanh nghiệp.
          </p>
        ...
        <div className="home-container">
          <header className="mb-6 max-w-2xl md:mb-8">
            ...
            <p className={`mt-2 ${SECTION_LEAD_CLASS}`}>
              Cùng bộ thẻ với trang chủ — bấm vào từng hướng để xem landing chi
              tiết.
            </p>
          </header>
