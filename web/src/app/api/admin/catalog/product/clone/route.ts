    ...
    const created = await prisma.$transaction(async (tx) => {
      const product = await tx.product.create({
        data: {
          ...
          licenseChannelDefault: source.licenseChannelDefault,
          licenseTermDefault: source.licenseTermDefault,
          seatsDefault: source.seatsDefault,
          activationMethodDefault: source.activationMethodDefault,
